...
def _cfg(url='pretrained_model/ptnt-ti-75.2.pth.tar', **kwargs):
    return {
        'url': url,
...
default_cfgs = {
    'tnt_ti_patch16_192': _cfg(
        input_size=(3, 192, 192), mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD,
    ),
...
class PyramidTNT(nn.Module):
    ...
    def load_param(self, model_path):
        ...
        for i in param_dict:
            if 'head' in i or "total_ops" in i or "total_params" in i:
                continue
